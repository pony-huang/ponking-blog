...
public class AboutController extends AbstractBaseController {
    ...
    public AboutController(IArticleService articleService, ICategoryService categoryService, ITagService tagService, ILinkService linkService, PBlogProperties config) {
