...
-- ----------------------------
INSERT INTO `blog_article` VALUES ('1', 'hello world My blog!', '你好，世界', 'https://i.picsum.photos/id/1002/4312/2868.jpg', '<h1><a id=\"Hello_World_0\"></a>Hello World</h1>\n<p>你好，世界。<br />\n欢迎使用本博客系统。<br />\n写博客需要坚持，一起努力加油吧！</p>\n', '# Hello World\n你好，世界。\n欢迎使用本博客系统。\n写博客需要坚持，一起努力加油吧！', '1', '2018-12-26 00:00:00', '2018-11-30 15:37:31', '0', '0', '0', null, '0', '0');
INSERT INTO `blog_article` VALUES ('2', '关于我', '关于我', 'https://i.picsum.photos/id/1002/4312/2868.jpg', '<p style=\"text-align: center;\">\r\n	<span style=\"font-size: 14pt;\">欢迎来到<strong>我的个人博客</strong></span>\r\n</p>\r\n<div class=\"alert alert-danger\">我是一个好人。<br>我真的是一个好人哦！\r\n</div>\r\n<div class=\"alert alert-success\">这是个自定义文章示例界面<br>内容完全自定义<br>嘿嘿嘿~</div>\r\n<div class=\"alert alert-danger\">博客项目在<a href=\"https://github.com/iszhouhua/blog\">这里https://github.com/iszhouhua/blog</a><br>参考的博客主题在<a href=\"https://github.com/ZEROKISEKI/hexo-theme-gal\">这里https://github.com/ZEROKISEKI/hexo-theme-gal</a><br>参考网站在<a href=\"https://www.mmgal.com/\">这里https://www.mmgal.com/</a></div>', '<p style=\"text-align: center;\">\r\n	<span style=\"font-size: 14pt;\">欢迎来到<strong>我的个人博客</strong></span>\r\n</p>\r\n<div class=\"alert alert-danger\">我是一个好人。<br>我真的是一个好人哦！\r\n</div>\r\n<div class=\"alert alert-success\">这是个自定义文章示例界面<br>内容完全自定义<br>嘿嘿嘿~</div>\r\n<div class=\"alert alert-danger\">博客项目在<a href=\"https://github.com/iszhouhua/blog\">这里https://github.com/iszhouhua/blog</a><br>参考的博客主题在<a href=\"https://github.com/ZEROKISEKI/hexo-theme-gal\">这里https://github.com/ZEROKISEKI/hexo-theme-gal</a><br>参考网站在<a href=\"https://www.mmgal.com/\">这里https://www.mmgal.com/</a></div>', '2', '2018-12-17 19:03:43', '2020-03-08 19:03:43', '0', '1', '0', null, '0', '2');
INSERT INTO `blog_article` VALUES ('3', '按国家拉动机关', '发士大夫', 'https://i.picsum.photos/id/1014/4312/2868.jpg', null, null, '1', '2020-03-19 04:20:20', '2020-03-19 04:20:20', '0', '0', '1', null, '0', '0');
INSERT INTO `blog_article` VALUES ('4', '噶山豆根', '发的第三方', 'https://i.picsum.photos/id/1012/4312/2868.jpg', null, null, '1', '2020-03-19 12:20:38', '2020-03-19 12:20:38', '0', '1', '0', null, '0', '1');
INSERT INTO `blog_article` VALUES ('5', 'adas dasd', 'asd 啊实打实', 'https://i.picsum.photos/id/1022/4312/2868.jpg', null, null, '3', '2020-03-19 23:03:00', '2020-03-19 23:03:00', '0', '1', '1', null, '0', '1');
INSERT INTO `blog_article` VALUES ('9', '123123123', '312hslhfjsdhflkjsdf', 'https://i.picsum.photos/id/1021/4312/2868.jpg', null, '123123123', '5', '2020-04-04 22:55:54', '2019-07-14 22:55:54', '0', '0', '0', '', '0', '0');
INSERT INTO `blog_article` VALUES ('10', 'asdafsdafasdfsdf', '1231231231231231231231231', 'https://i.picsum.photos/id/1011/4312/2868.jpg', null, 'dfsadfsdfasdfsadfsdfsdf\nsdfsdfsdfsdfsdfsdf', '7', '2020-04-04 22:57:11', '2020-01-01 22:57:11', '1', '0', '1', '', '0', '0');
INSERT INTO `blog_article` VALUES ('11', '发士大夫撒地方', '发射点发射点发生', 'https://i.picsum.photos/id/1033/4312/2868.jpg', null, '123123123', '3', '2020-04-04 23:03:09', '2019-07-04 23:03:09', '0', '0', '0', '', '0', '0');
INSERT INTO `blog_article` VALUES ('12', '出色的防守', '12312312312', 'https://i.picsum.photos/id/1032/4312/2868.jpg', null, '发大水发射点发射点发', '3', '2020-04-04 23:04:45', '2020-04-04 23:04:45', '1', '0', '0', '', '0', '0');
INSERT INTO `blog_article` VALUES ('13', '1005 Spell It Right (20 分)', 'Given a non-negative integer *N*, your task is to compute the sum of all the digits of *N*, and output every digit of the sum in English.', 'https://i.picsum.photos/id/1044/4312/2868.jpg', null, 'Given a non-negative integer *N*, your task is to compute the sum of all the digits of *N*, and output every digit of the sum in English.\n### Input Specification:\n\nEach input file contains one test case. Each case occupies one line which contains an *N* (≤10100).\n\n### Output Specification:\n\nFor each test case, output in one line the digits of the sum in English words. There must be one space between two consecutive words, but no extra space at the end of a line.\n\n### Sample Input:\n\n```in\n12345\n```\n\n### Sample Output:\n\n```out\none five\n```\n\n题意:略.\n\n分析:相加的sum,利用stringstream转换string,将string每一位字符转为对应的读音.\n\n### 代码:\n```\n#include <iostream>\n#include<string.h>\n#include<sstream>\n\nusing namespace std;\n\nint main()\n{\n    string num[10]={\"zero\",\"one\",\"two\",\"three\",\"four\",\"five\",\"six\",\"seven\",\"eight\",\"nine\"};\n    string s;\n    stringstream ss;\n    long long int sum=0;\n    getline(cin,s);\n    for(int i=0;i<s.length();i++){\n        sum+=s[i]-\'0\';\n    }\n    ss<<sum;\n    ss>>s;\n    for(int i=0;i<s.length();i++){\n        if(i!=0) cout<<\" \";\n        cout<<num[s[i]-\'0\'];\n    }\n    return 0;\n}\n```', '2', '2020-04-07 22:25:00', '2020-04-07 22:25:00', '0', '0', '0', '', '0', '1');
...
CREATE TABLE `blog_article_tag` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=235 DEFAULT CHARSET=utf8 COMMENT='文章与标签的对应关系';

-- ----------------------------
-- Records of blog_article_tag
-- ----------------------------
INSERT INTO `blog_article_tag` VALUES ('4', '2', '2');
INSERT INTO `blog_article_tag` VALUES ('14', '12', '3');
INSERT INTO `blog_article_tag` VALUES ('225', '1', '1');
INSERT INTO `blog_article_tag` VALUES ('226', '1', '2');
INSERT INTO `blog_article_tag` VALUES ('227', '1', '4');
INSERT INTO `blog_article_tag` VALUES ('228', '13', '2');
INSERT INTO `blog_article_tag` VALUES ('229', '1', '2');
INSERT INTO `blog_article_tag` VALUES ('230', '2', '3');
INSERT INTO `blog_article_tag` VALUES ('231', '4', '3');
INSERT INTO `blog_article_tag` VALUES ('232', '2', '7');
INSERT INTO `blog_article_tag` VALUES ('233', '3', '2');
INSERT INTO `blog_article_tag` VALUES ('234', '1', '6');
...
CREATE TABLE `blog_tag` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='标签表';
...
INSERT INTO `blog_tag` VALUES ('29', 'C++ new', null);
