...
INSERT INTO `blog_article` VALUES ('32', 'string', 'string', 'https://ponking-blog.oss-cn-beijing.aliyuncs.com/2020/10/18/fcd3d0267fc7465e9550bce81f071166.png', '', '# spring boot 整合shiro 错误\n> 最近博客添加缓存功能,发现Shiro中自定义的过滤器不能添加在SpringBoot容器中,否则会抛出(No SecurityManager accessible to the calling code, either bound to the org.apache.shiro.util.ThreadContext or as a vm static singleton.  This is an invalid application configuration.),只需直接new出对象就行.##', '4', '2020-10-01 23:47:13', '2020-10-01 23:47:13', '0', '0', '0', 'string', '3', '1');
...
CREATE TABLE `blog_article_tag` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=401 DEFAULT CHARSET=utf8 COMMENT='文章与标签的对应关系';
...
INSERT INTO `blog_article_tag` VALUES ('397', '1', '1');
INSERT INTO `blog_article_tag` VALUES ('398', '1', '2');
INSERT INTO `blog_article_tag` VALUES ('399', '1', '3');
INSERT INTO `blog_article_tag` VALUES ('400', '32', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='博客配置表';
...
INSERT INTO `blog_config` VALUES ('3', 'BLOG_DESCRIPTION', '我就是我，颜色不一样的烟火', '1', '网站描述');
INSERT INTO `blog_config` VALUES ('4', 'BLOG_URL', 'http://127.0.0.1:8080/', '1', '网站链接');
INSERT INTO `blog_config` VALUES ('5', 'BLOG_AUTHOR', 'Pony哥', '1', '网站作者');
INSERT INTO `blog_config` VALUES ('6', 'BLOG_AVATAR', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1603185401353&di=65726f6caf2aeda83f48bd6da9999ba5&imgtype=0&src=http%3A%2F%2F5b0988e595225.cdn.sohucs.com%2Fimages%2F20170825%2Fd0abecc9e3904e428d3e303d6518473a.gif', '1', '头像');
INSERT INTO `blog_config` VALUES ('7', 'BLOG_NOTICE', '公告', '1', '公告');
INSERT INTO `blog_config` VALUES ('8', 'DEFAULT_IMAGE', 'https://ponking-blog.oss-cn-beijing.aliyuncs.com/2020/10/18/fcd3d0267fc7465e9550bce81f071166.png', '1', '默认预览图');
INSERT INTO `blog_config` VALUES ('9', 'AUTHOR_DESCRIPTION', '我就是我，颜色不一样的烟火', '1', '头像下的描述内容');
...
INSERT INTO `blog_config` VALUES ('13', 'BACKGROUND_LIST', '', '1', '网站的背景图片集合，格式为JSON数组');
INSERT INTO `blog_config` VALUES ('14', 'BLOG_HEAD', '', '1', '博客头部插入的代码，如站点验证代码等');
INSERT INTO `blog_config` VALUES ('15', 'BLOG_SCRIPT', '\n', '1', '博客尾部插入的脚本，如统计代码、推送代码等');
INSERT INTO `blog_config` VALUES ('16', 'FILE_STORAGE', '', '2', '云/本地存储配置信息');
INSERT INTO `blog_config` VALUES ('17', 'AUTHOR_CITY', '圣地亚哥', '1', '作者地方');
INSERT INTO `blog_config` VALUES ('18', 'BLOG_ABOUT', '\r\n\r\n# PBlog\r\n\r\n- [前台展示链接](http://39.106.97.88:80)\r\n- [后台展示链接](http://39.106.97.88:80/admin/index) \r\n\r\n> 账户：admin,密码：123456\r\n\r\n## 前台\r\n\r\n**基于[hexo-theme-icarus](https://github.com/ppoffice/hexo-theme-icarus)**\r\n![markdown](https://raw.githubusercontent.com/PonKing66/ponking-blog/master/images/fc6233ade79e0d5e5723c7f87a65700.png)\r\n![markdown](https://raw.githubusercontent.com/PonKing66/ponking-blog/master/images/4f5d267468cfba4f2ad0cb2ee7d9dd9.png)\r\n\r\n## 后台\r\n\r\n**[vue-admin-plog](https://github.com/PonKing66/vue-admin-pblog) 基于vue-admin-template**\r\n![markdown](https://raw.githubusercontent.com/PonKing66/ponking-blog/master/images/4f5d267468cfba4f2ad0cb2ee7d9dxa.png)\r\n![markdown](https://raw.githubusercontent.com/PonKing66/ponking-blog/master/images/4f5d267468cfba4f2ad0cb2ee7d94h2.jpg)\r\n\r\n## 后端\r\n\r\n- mysql,mybatis-plus,lombok,springboot,jwt,shiro,swagger,druid\r\n\r\n## 其他\r\n\r\n- maven,mysql,idea\r\n\r\n### loading\r\n\r\n#### 2020年10月18日\r\n\r\n- 修改为动态配置博客信息\r\n\r\n#### 2020年10月17日\r\n\r\n- 修复前台hexo样式若干问题\r\n- 验证码插件改为 [EasyCaptcha](https://gitee.com/whvse/EasyCaptcha)\r\n\r\n#### 2020年10月4日\r\n\r\n- 添加评论接口\r\n- 前后端整合（vue-admin-plog整合SpringBoot）\r\n\r\n#### 2020年9月28日\r\n\r\n- 添加PageUtil\r\n- 统一类名\r\n- 添加Cache缓存token,用于token注销判断\r\n\r\n#### 2020年9月2日\r\n\r\n-  修复若干bug\r\n-  整理前台vue\r\n-  重写ApiArticleController', '1', '网站关于我页面信息');
...
-- ----------------------------
INSERT INTO `blog_user` VALUES ('1', 'admin', '管理员', 'ea49ba308fa797beeaa90e482c0576b6', '7af4a47cb431d8f4', 'admin@admin.com', '64e1b8d34f425d19e1ee2ea7236d3028', '2018-12-31 20:13:25', '2018-12-31 20:13:25', '0', '0');
...
-- ----------------------------
INSERT INTO `qrtz_cron_triggers` VALUES ('schedulerFactoryBean', 'elasticSearch', 'QuartzJobGroups', '0/2 * * * * ?', 'Asia/Shanghai');
INSERT INTO `qrtz_cron_triggers` VALUES ('schedulerFactoryBean', 'elasticSearchJob', 'QuartzJobGroups', '0/30 * * * * ?', 'Asia/Shanghai');
INSERT INTO `qrtz_cron_triggers` VALUES ('schedulerFactoryBean', 'executeJobTrigger', 'DEFAULT', '0/2 * * * * ?', 'Asia/Shanghai');
...
-- ----------------------------
INSERT INTO `qrtz_fired_triggers` VALUES ('schedulerFactoryBean', 'PONKING16037907711731603790771179', 'executeJobTrigger', 'DEFAULT', 'PONKING1603790771173', '1603790822012', '1603790824000', '0', 'ACQUIRED', null, null, '0', '0');
...
-- ----------------------------
INSERT INTO `qrtz_job_details` VALUES ('schedulerFactoryBean', 'elasticSearch', 'QuartzJobGroups', null, 'com.ponking.pblog.quartz.job.compoent.EsSearchJob', '0', '0', '0', '0', );
INSERT INTO `qrtz_job_details` VALUES ('schedulerFactoryBean', 'elasticSearchJob', 'QuartzJobGroups', null, 'com.ponking.pblog.quartz.job.EsSearchJob', '0', '0', '0', '0', );
INSERT INTO `qrtz_job_details` VALUES ('schedulerFactoryBean', 'executeJobDetail', 'QuartzJobGroups', null, 'com.ponking.pblog.quartz.factory.InvokingJobDetailFactory', '1', '0', '0', '1', );
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('schedulerFactoryBean', 'PONKING1603790771173', '1603790815184', '20000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('schedulerFactoryBean', 'elasticSearch', 'QuartzJobGroups', 'elasticSearch', 'QuartzJobGroups', null, '1603520164000', '1603520162000', '5', 'PAUSED', 'CRON', '1603520120000', '0', null, '0', '');
INSERT INTO `qrtz_triggers` VALUES ('schedulerFactoryBean', 'elasticSearchJob', 'QuartzJobGroups', 'elasticSearchJob', 'QuartzJobGroups', null, '1603790850000', '1603790820000', '5', 'WAITING', 'CRON', '1603517399000', '0', null, '0', '');
INSERT INTO `qrtz_triggers` VALUES ('schedulerFactoryBean', 'executeJobTrigger', 'DEFAULT', 'executeJobDetail', 'QuartzJobGroups', null, '1603790824000', '1603790822000', '0', 'ACQUIRED', 'CRON', '1603790771000', '0', null, '0', '');
